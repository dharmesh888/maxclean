...
<section >
  <div class="comment-section container-fluid p-0 ">
    <h5 class="font-weight-bold text-center">LEAVE YOUR COMMENTS</h5>
    <div class="row pb-4">
      <div class="col-lg-4 comment-section-input">
      ...
      <div class="col-lg-4 comment-section-input">
        <input type="text" class="add" name="Name" placeholder="Subject">
      </div>
    </div>
    <input type="text" name="massage" placeholder="Message" class="comment-section-input-msg">
    <button type="button" class="btn">SUBMIT</button>
  </div>
</section>
<!-- //////////////////////// COMMENT-SECTION-DETAILS///////////////////////// -->
<div class="comment-section-contacts container-fluid ">
  <div class="row">
    <div class="col-lg-4 col-12 text-center">
     ...
     <div class="col-lg-4 col-12 text-center">
      ...
      <div class="icons rounded-circle row justify-content-center align-items-center position-relative">
         <i class="fas fa-phone-alt text-primary"></i>
      </div>
...
<section class="comment-section-googlemaps container-fluid pt-5 p-0">
